...
#define STORAGE_TANK_ON 1
#define STORAGE_TANK_OFF 0
 ...
 */
storage_tank* create_storage_tank(unsigned int min_level, unsigned int max_level);

/**
 * переключить резервуар в рабочее состояние
 * @param st указатель на резервуар
 */
void turn_on(storage_tank* st);

/**
 * переключить резервуар в нерабочее состояние
 * @param st указатель на резервуар
 */
void turn_off(storage_tank* st);
 ...
 */
void set_minimum_level(storage_tank* st, unsigned int min_level);
 ...
 */
unsigned int get_minimum_level(storage_tank* st);
 ...
 */
void set_maximum_level(storage_tank* st, unsigned int max_level);
 ...
 */
unsigned int get_maximum_level(storage_tank* st);
 ...
 */
unsigned int get_curent_level(storage_tank* st);
 ...
 * @param st указатель на резервуар
 * @return 0 - нерабочее состояние, 1 - рабочее состояние
 */
int get_state_injection_pump(storage_tank* st);
 ...
 */
unsigned int get_speed_injection_pump(storage_tank* st);
 ...
 * @return 0 - нерабочее состояние, 1 - рабочее состояние
 */
int get_state_pumping_pump(storage_tank* st);
 ...
 */
unsigned int get_speed_pumping_pump(storage_tank* st);
